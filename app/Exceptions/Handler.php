...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Exception $e)
    {
        ...
        // MongoDB/Cache connection errors
        if ($e instanceof \MongoDB\Driver\Exception\ConnectionTimeoutException
            || $e instanceof \MongoDB\Driver\Exception\AuthenticationException) {
            if (!env('APP_DEBUG')) {
            ...
            return response()
                ->json([
                    ...
                    'message' => 'Failed to communicate with MongoDB.',
                    'error' => env('APP_DEBUG') ?  $e->getMessage() : null,
                    'report_url' => env('GITHUB_REPORTING', false) ? (string) $githubReport : null
                ], 500);
        }
