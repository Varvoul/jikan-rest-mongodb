...
// PHP 8.0 compatibility: Lumen 5.8's constructor resets error_reporting()
// Re-set to exclude E_DEPRECATED so getClass() doesn't throw ErrorException
...
| your own bindings here if you like or can make another file.
|
*/
